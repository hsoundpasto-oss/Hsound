...
class _SongPlayerScreenState extends State<SongPlayerScreen> {
  ...
  String _extractSpotifyTrackId(String url) {
    try {
      ...
      RegExp regExp = RegExp(
          r'spotify\.com\/(?:intl-[a-z]{2}\/)?(?:embed\/)?track\/([a-zA-Z0-9]{22})');
      final match = regExp.firstMatch(url);
...
// Función para compartir canción - CORREGIDA
  void _shareCurrentSong() async {
    try {
      await ShareService.shareSong(
        songTitle: widget.songTitle,
        artistName: widget.artistName,
        // 🎯 ELIMINADO: songUrl (ya no se necesita)
      );
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          if (widget.platform == 'spotify') _buildSpotifyNotice(),
              ...
              child: Column(
                ...
                children: [
                  const CircularProgressIndicator(
                    valueColor:
                        AlwaysStoppedAnimation<Color>(Color(0xFF4ADE80)),
                  ),
